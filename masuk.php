            ...
            <div id="layoutSidenav_content">
                <main class="bg-white text-dark ">
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Digital Store - Barang Masuk</h1>
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <?php
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $keterangan; ?></td>
                                            <td> 
                                                <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#edit<?= $id_masuk; ?>">Edit</button>
                                                <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#delete<?= $id_masuk; ?>">Delete</button>
                                            </td>
                                        </tr>
