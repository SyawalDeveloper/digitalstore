...
<html lang="en">
    <head>
        ...
        <title>Dashboard - Digital Store</title>
            ...
            <div id="layoutSidenav_content">
                <main class="bg-light text-dark">
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Welcome to Digital Store</h1>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="alert alert-danger alert-dismissible">
                                ...
                                <strong>Perhatian!</strong> Stok <strong> <?= $barang; ?> </strong> telah habis.
                            </div>
...
<tr>
    ...
    <td><?= $stock; ?></td>
    <td> 
        <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#edit<?= $id_barang; ?>">Edit</button>
        <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#delete<?= $id_barang; ?>">Delete</button>
    </td>
</tr>
...
<div class="modal fade" id="delete<?= $id_barang; ?>">
    <div class="modal-dialog">
        <div class="modal-content">
            <!-- Modal Header -->
            <div class="modal-header">
                <h4 class="modal-title">Hapus Barang</h4>k
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            <!-- Modal body -->
            <form method="POST">
